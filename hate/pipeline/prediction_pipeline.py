...
class PredictionPipeline:
    ...
    def predict(self, best_model_path, text) -> str:
        ...
        try:
             ...
             if pred>0.5:
                ...
                print("Hate and Abuse Detected")
                return "Hate and Abuse Detected"
             else:
                print("No Hate and Abuse Detected")
                return "No Hate and Abuse Detected"
